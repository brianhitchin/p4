            ...
            <div className="bottomholder">
                {exstory && <div className="samples hoverme" onClick={() => {history.push('/story/1')}}>
                        ...
                        <div className="previewholder">
                            ...
                            <div className="innerpreview">
                                {onestoryloaded[1] && <div centerme2><span className="boldme">{"Name: "}</span><span className="underlineme">{onestoryloaded[1].title}</span></div>}
                                {onestoryloaded[1] && <div className="tagholder centerme2"><span className="boldme">{"Tag: "}</span><img src={onestoryloaded[1].topicId == 1 ? t1 : t2} alt="tag" className="tagimg"></img></div>}
                ...
                {exexercise && <div className="samples hoverme" onClick={() => {history.push('/exercise/1')}}>
                        ...
                        <div className="previewholder">
                            ...
                            <div className="innerpreview">
                                {oneexerciseloaded[1] && <div className="centerme2"><span className="boldme">{"Name: "}</span><span className="underlineme">{oneexerciseloaded[1].name}</span></div>}
                                {oneexerciseloaded[1] && <div className="tagholder centerme2"><span className="boldme">{"Tag: "}</span><img src={oneexerciseloaded[1].topicId == 1 ? t1 : t2} alt="tag" className="tagimg"></img></div>}
